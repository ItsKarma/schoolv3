...
const Q1 = () => {
  ...
  const answer = `${topNum1 - topNum2 - topNum3}/${bottomNum}`
  const formula = `${fraction1} - ${fraction2} - ${fraction3}`

  return {
    question: `${name} has ${fraction1} cup of milk. ${name} used ${fraction2} to make waffles and ${fraction3} cup to make pancakes. How much milk does ${name} have left after making both?`,
