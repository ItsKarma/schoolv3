...
const F1 = () => {
  ...
  return {
    question: `${randomNames[0]} sold ${num1} ${item} for $${value1} each. ${randomNames[1]} sold ${num2} ${item} for $${value2} each. How money did ${randomNames[0]} and ${randomNames[1]} make all together?`,
